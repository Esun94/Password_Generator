...
// if(isNaN(passLengthInt) || passLengthInt < 8 || passLengthInt > 128) {
//   alert('Must choose password 8 - 128 characters long')
//   console.log()
// } else if (!lowerCase || !upperCase || !numberChar || !specialChar) {
//   alert('Must choose atleast 1 type of characters')
//   console.log()
// } else {
